...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("lordsoftherealm:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("lordsoftherealm:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("lordsoftherealm:pinky", pinkyEventData);
	}
}
